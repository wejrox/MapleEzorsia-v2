...
#include "comdef.h"
//#include "winnt.h"
template <typename TType> TType ReadValue(DWORD dwAddr) { return *reinterpret_cast<TType*>(dwAddr); }
...
struct ZInetAddr
{
	sockaddr_in my_IP_wrapper;
};	//10 bytes
//struct _WSABUF { unsigned int len; char* buf; };
__declspec(align(4))struct ZSocketBuffer : ZRefCounted, _WSABUF, ZRefCountedAccessorBase
{
	ZRef<ZSocketBuffer> _m_pParent;
};//__unaligned __declspec
struct ZSocketBase
{
	SOCKET _m_hSocket;
};
...
struct _com_ptr_t_com_IIID_IWzGr2D
{
	IWzGr2D* m_pInterface;
};
...
struct __declspec(align(1)) FUNCKEY_MAPPED
{
	char nType;
	int nID;
};
...
struct _com_ptr_t_IWzGr2DLayer_GUID_6dc8c7ce_8e81_4420_b4f6_4b60b7d5fcdf
{
...
struct INetMsgHandlerVtbl
{
	void (__thiscall* OnPacket)(INetMsgHandler* pThis, int, CInPacket*);
};
...
struct IGObjVtbl
{
	void (__thiscall* Update)(IGObj* pThis);
};
...
//};
struct CClientSocket_CONNECTCONTEXT
{
	ZList<ZInetAddr> my_IP_Addresses;
	void* posList;
	int bLogin;
}; //size 28 //4 bytes dd for voids //__POSITION*
...
{	//utility function also found in mapleclient template
...
using _CWndCreateWnd_t = void(__fastcall*)(void* pThis, void* edx, int nLeft, int nTop, int nWidth, int nHeight, int z, int bScreenCoord, void* esi, int bSetFocus);
...
static _CWndCreateWnd_t _CWndCreateWnd_Hook = [](void* pThis, void* edx, int nLeft, int nTop, int nWidth, int nHeight, int z, int bScreenCoord, void* esi, int bSetFocus)
	-> void {
	_sub_9DE4D2(pThis, edx, nLeft, nTop, nWidth, nHeight, z, bScreenCoord, esi, bSetFocus); //changing the values here will modify the result of the function
	//usually put changes here //this only runs after the original execution
};
using _CLoginSendSelectCharPacket_t = void(__fastcall*)(void* pThis, void* edx);    //sub_5F726D    end 005F7690
...
static _CLoginSendSelectCharPacket_t _CLoginSendSelectCharPacket_Hook = [](void* pThis, void* edx)
	-> void {
	_sub_5F726D(pThis, edx); //changing the values here will modify the result of the function
...
void* nPriority = nullptr;
//NOTE: resman rewrites do not match native typing in IDA. this may have been done purposely for the rewrite
using _CWvsApp__InitializeResMan_t = void(__fastcall*)(CWvsApp* pThis, void* edx);	//ty to all the contributors of the ragezone release: Client load .img instead of .wz v62~v92 //ty y785	//char* ecx, char* edx
...
using _PcCreateObject_IWzResMan_t = void(__cdecl*)(const wchar_t* sUOL, void* pObj, void* pUnkOuter);   //sub_9FAF55    end 009FAFB9
...
using _PcCreateObject_IWzNameSpace_t = void(__cdecl*)(const wchar_t* sUOL, void* pObj, void* pUnkOuter);    //sub_9FAFBA    end 009FB01E
...
using _PcCreateObject_IWzFileSystem_t = void(__cdecl*)(const wchar_t* sUOL, void* pObj, void* pUnkOuter);   //sub_9FB01F    end 009FB083
...
using _sub_9FB084_t = void(__cdecl*)(const wchar_t* sUOL, void* pObj, void* pUnkOuter);   //sub_9FB01F    end 009FB083
...
using _CWvsApp__Dir_BackSlashToSlash_t = void(__cdecl*)(char* sDir);
...
using _CWvsApp__Dir_upDir_t = void(__cdecl*)(char* sDir);
...
using _bstr_ctor_t = void*(__fastcall*)(void* pThis, void* edx, const char* str); //dont use comutil.h bstr_t, nXXXon's is different   //sub_406301	end	00406356
...
using _sub_425ADD_t = void*(__fastcall*)(Ztl_bstr_t* pThis, void* edx, const char* str); //can make it return the ptr of inserted val   //sub_425ADD
...
using _IWzFileSystem__Init_t = HRESULT(__fastcall*)(void* pThis, void* edx, Ztl_bstr_t sPath); //sub_9F7964	//HRESULT
...
using _sub_402EA5_t = unsigned int(__thiscall*)(_bstr_t__Data_t* pThis);
...
using _sub_4039AC_t = void*(__thiscall*)(Ztl_variant_t* pvargDest, Ztl_variant_t* pvargSrc, char a3);//could be wrong
...
using _IWzNameSpace__Mount_t = HRESULT(__fastcall*)(void* pThis, void* edx, Ztl_bstr_t sPath, void* pDown, int nPriority); //HRESULT
...
using _sub_5D995B_t = Ztl_variant_t*(__fastcall*)(void* pThis, void* edx, Ztl_variant_t* result, Ztl_bstr_t sPath);
...
using _sub_4032B2_t = IUnknown*(__fastcall*)(Ztl_variant_t* pThis, void* edx, bool fAddRef, bool fTryChangeType);
...
using _sub_9FCD88_t = void(__fastcall*)(void* pThis, void* edx, IUnknown* p);
...
using _StringPool__GetString_t = ZXString<char>* (__fastcall*)(void* pThis, void* edx, ZXString<char>* result, unsigned int nIdx, char formal); //also ty to the creators of MapleClientEditTemplate
...
using _sub_78C8A6_t = unsigned int*(__fastcall*)(unsigned int [], void* edx);  //sub_78C8A6	end 0078D165	//custom return
...
using _CUIStatusBar__ChatLogAdd_t = void(__fastcall*)(void* pThis, void* edx, const char* sChat, int lType, int nChannelID, int bWhisperIcon, ZRef<void>* pItem);
...
static _CUIStatusBar__ChatLogAdd_t _CUIStatusBar__ChatLogAdd_Hook = [](void* pThis, void* edx, const char* sChat, int lType, int nChannelID, int bWhisperIcon, ZRef<void>* pItem) {
	...
	while (m_aChatLog->GetCount() > 1000)
	{ // you can set your custom limit here //not working, crashes
		auto idx = m_aChatLog->IndexOf(nullptr);	//ty to releaser of forum.ragezone.com/threads/set-any-chat-bar-limit-default-is-64.1209514/
		m_aChatLog->RemoveAt(idx);
	}
	_sub_8DB070(pThis, nullptr, sChat, lType, nChannelID, bWhisperIcon, pItem);
};

using _sub_44E6C3_t = int(__cdecl*)(int a1, unsigned int a2);
static auto _sub_44E6C3 = reinterpret_cast<_sub_44E6C3_t>(0x0044E6C3);

using _sub_44E546_t = unsigned int(__cdecl*)(unsigned __int8* a1, int a2);	//sub_44E546	end 0044E5D4
static auto _sub_44E546 = reinterpret_cast<_sub_44E546_t>(0x0044E546);

using _sub_44E5D5_t = unsigned int(__cdecl*)(int a1, void* a2, size_t a3);	//1	//sub_44E5D5	end	0044E6C2
static auto _sub_44E5D5 = reinterpret_cast<_sub_44E5D5_t>(0x0044E5D5);	//3

using _sub_A61DF2_t = void(__cdecl*)(void* lpMem);//void __cdecl free(void *)
static auto _sub_A61DF2 = reinterpret_cast<_sub_A61DF2_t>(0x00A61DF2);

using _sub_44E716_t = unsigned int(__cdecl*)(int a1, void* a2, size_t a3);	//sub_44E716	end 0044E822
static auto _sub_44E716 = reinterpret_cast<_sub_44E716_t>(0x0044E716);

using _sub_44E88E_t = int(__stdcall* (__stdcall*)(HINSTANCE__* hModule, const char* lpProcName))();	//sub_44E88E	end	0044EA61	//GetProcAddress function (libloaderapi.h), not sure if nXXXon changed it
...
using _sub_44EA64_t = HMODULE(__fastcall*)(void* pThis, void* edx);	//sub_44EA64	end	0044EBEB
static auto _sub_44EA64 = reinterpret_cast<_sub_44EA64_t>(0x0044EA64);

using _sub_44EC9C_t = DWORD*(__cdecl*)(int a1);	//1	//sub_44EC9C	end	0044ED46
static auto _sub_44EC9C = reinterpret_cast<_sub_44EC9C_t>(0x0044EC9C);	//3	//HideDll

using _sub_403065_t = void*(__thiscall*)(ZAllocEx<ZAllocAnonSelector>* pThis, unsigned int uSize);
...
using _sub_4031ED_t = void(__thiscall*)(ZAllocEx<ZAllocAnonSelector>* pThis, DWORD* a2);	//ZAllocEx<ZAllocAnonSelector>::Free
static auto _sub_4031ED = reinterpret_cast<_sub_4031ED_t>(0x004031ED);	//3

using _sub_44ED47_t = void(__cdecl*)();//sub_44ED47	end	0044EEE6
...
using _sub_496ADF_t = DWORD*(__thiscall*)(DWORD* pThis);
static auto _sub_496ADF = reinterpret_cast<_sub_496ADF_t>(0x00496ADF);	//3

using _sub_9F94A1_t = ZXString<char>*(__thiscall*)(CWvsApp* pThis, ZXString<char>* result, int nArg);
...
using _sub_496E9F_t = int(__thiscall*)(DWORD* pThis);
static auto _sub_496E9F = reinterpret_cast<_sub_496E9F_t>(0x00496E9F);	//3

using _sub_494C1A_t = DWORD*(__thiscall*)(DWORD* pThis, char* cp, unsigned short netshort);
static auto _sub_494C1A = reinterpret_cast<_sub_494C1A_t>(0x00494C1A);	//3

using _sub_494BE9_t = DWORD*(__thiscall*)(void* pThis, int a2);
...
using _sub_496EDD_t = void(__thiscall*)(ZList<ZInetAddr>* pThis);	//void __thiscall ZList<ZInetAddr>::RemoveAll(ZList<ZInetAddr> *this)
...
using _sub_496E6B_t = int(__thiscall*)(int* pThis, void* a2);
static auto _sub_496E6B = reinterpret_cast<_sub_496E6B_t>(0x00496E6B);	//3

using _sub_494C7A_t = int(__thiscall*)(void* pThis, __int16 a2, int a3);
static auto _sub_494C7A = reinterpret_cast<_sub_494C7A_t>(0x00494C7A);	//3

using _sub_496B9B_t = void(__thiscall*)(ZList<ZInetAddr>* pThis, ZList<ZInetAddr>* l);	//void __thiscall ZList<ZInetAddr>::AddTail(ZList<ZInetAddr> *this, ZList<ZInetAddr> *l)
static auto _sub_496B9B = reinterpret_cast<_sub_496B9B_t>(0x00496B9B);	//3

using _sub_494D07_t = void(__fastcall*)(CClientSocket_CONNECTCONTEXT* pThis, void* edx, CClientSocket_CONNECTCONTEXT* a2); //sub_494D07	end	00494D2C
static auto _sub_494D07 = reinterpret_cast<_sub_494D07_t>(0x00494D07);	//3 //unknown function, part of connect

using _sub_4969EE_t = void(__thiscall*)(CClientSocket* pThis); //void __thiscall CClientSocket::ClearSendReceiveCtx(CClientSocket *this)
static auto _sub_4969EE = reinterpret_cast<_sub_4969EE_t>(0x004969EE);	//3

using _sub_494857_t = void(__thiscall*)(ZSocketBase* pThis);	//void __thiscall ZSocketBase::CloseSocket(ZSocketBase* this)
static auto _sub_494857 = reinterpret_cast<_sub_494857_t>(0x00494857);	//switching to void* instead of set up Z smart pointer

using _sub_496369_t = void(__thiscall*)(CClientSocket* pThis);  //CClientSocket::Close	//CClientSocket* pThis
static auto _sub_496369 = reinterpret_cast<_sub_496369_t>(0x00496369);	//3

using _sub_495FD2_t = ZSocketBuffer*(__cdecl*)(unsigned int u);	//ZSocketBuffer::Alloc(unsigned int u)
static auto _sub_495FD2 = reinterpret_cast<_sub_495FD2_t>(0x00495FD2);	//3

using _sub_496C2B_t = void(__thiscall*)(void* pThis);	//__thiscall ZRef<ZSocketBuffer>::~ZRef<ZSocketBuffer>(ZRef<ZSocketBuffer> *this)
static auto _sub_496C2B = reinterpret_cast<_sub_496C2B_t>(0x00496C2B);

using _sub_4062DF_t = void(__cdecl*)(void* pData); //void __cdecl ZXString<char>::_Release(ZXString<char>::_ZXStringData *pData)  //use ZXString<char>::~ZXString as destructor
static auto _sub_4062DF = reinterpret_cast<_sub_4062DF_t>(0x004062DF);	//_ZXStringData *pData

using _sub_46F37B_t = int(__cdecl*)(ZXString<char>* s, const char* pSrc, unsigned int uRemain);	//CIOBufferManipulator::DecodeStr
...
using _sub_4065A6_t = int(__thiscall*)(DWORD* pThis, int a2);	//COutPacket::Encode4
static auto _sub_4065A6 = reinterpret_cast<_sub_4065A6_t>(0x004065A6);

using _sub_406549_t = int(__thiscall*)(DWORD* pThis, char a2);
static auto _sub_406549 = reinterpret_cast<_sub_406549_t>(0x00406549);	//COutPacket::Encode1

using _sub_51E834_t = void(__thiscall*)(CPatchException* pThis, int nTargetVersion);//void __thiscall CPatchException::CPatchException(CPatchException* this, int nTargetVersion)
static auto _sub_51E834 = reinterpret_cast<_sub_51E834_t>(0x0051E834);

auto _byte_BF1AD0 = reinterpret_cast<char*>(0x00BF0B00); //??
auto _byte_BF1ACF = reinterpret_cast<char*>(0x00BF1ACF); //??
...
constexpr DWORD dw_sub_9F9808 = 0x009F9808;
...
//	}
//}
using _sub_9F9808_t = const char*(__cdecl*)(void);	//const char* __cdecl CWvsApp::GetExceptionFileName()
...
using _sub_495704_t = int(__thiscall*)(DWORD* pThis, int a2, int a3, int a4, int a5, int a6, int a7, int a8);
static auto _sub_495704 = reinterpret_cast<_sub_495704_t>(0x00495704);

using _sub_49588D_t = int(__thiscall*)(void* pThis);
static auto _sub_49588D = reinterpret_cast<_sub_49588D_t>(0x0049588D);

using _sub_49637B_t = void(__thiscall*)(CClientSocket* pThis, void* oPacket);	//CClientSocket::SendPacket	//const struct COutPacket* a2
...
using _sub_46C00C_t = void*(__thiscall*)(DWORD* pThis, void* a2, size_t a3);	//COutPacket::EncodeBuffer
static auto _sub_46C00C = reinterpret_cast<_sub_46C00C_t>(0x0046C00C);

using _sub_4956A6_t = signed int(__thiscall*)(DWORD* pThis);
static auto _sub_4956A6 = reinterpret_cast<_sub_4956A6_t>(0x004956A6);
constexpr DWORD dw_sub_4959B8 = 0x004959B8;
...
using _sub_4959B8_t = unsigned int(__fastcall*)(void* pThis, void* edx, void* pData, unsigned int uSize);	////sub_4959B8 end 00495A86
...
using _sub_496CA9_t = char* (__thiscall*)(ZArray<unsigned char>* pThis, unsigned int u);	//char *__thiscall ZArray<unsigned char>::_Alloc(ZArray<unsigned char> *this, unsigned int u, ZAllocHelper *_ALLOC)
...
using _Concurrency_details_AutoDeleter_t = int(__thiscall*)(int (__stdcall**** pThis)(signed int));   //@ 00496A0F ///???
...
using _sub_A60BB7_t = void(__stdcall*)(void* pExceptionObject, _s__ThrowInfo2* pThrowInfo);//_CxxThrowException	//void *pExceptionObject, _s__ThrowInfo*
...
using _dword_BF060C_t = unsigned int(__stdcall*)();	// unsigned int (__stdcall *timeGetTime)(); //IDB wrong
static auto _dword_BF060C = reinterpret_cast<_dword_BF060C_t>(0x00BF060C);//!!use microsoft version

using _dword_AF036C_t = SOCKET(__stdcall*)(int, int, int);	//SOCKET __stdcall socket(int af, int type, int protocol)
static auto _dword_AF036C = reinterpret_cast<_dword_AF036C_t>(0x00AF036C);//!!use microsoft version

using _dword_AF0364_t = int(__stdcall*)(void);	//ZAPI.WSAGetLastError()
static auto _dword_AF0364 = reinterpret_cast<_dword_AF0364_t>(0x00AF0364);//!!use microsoft version

using _dword_BF0640_t = int(__stdcall*)(void);	//ZAPI.WSAGetLastError() 2?	//C6DB18
static auto _dword_BF0640 = reinterpret_cast<_dword_BF0640_t>(0x00BF0640);//!!use microsoft version

using _dword_BF0448_t = HWND__*(__stdcall*)(void);	// HWND__ *(__stdcall *GetDesktopWindow)();
static auto _dword_BF0448 = reinterpret_cast<_dword_BF0448_t>(0x00BF0448);//!!use microsoft version

using _dword_BF0444_t = int(__stdcall*)(HWND__*);	//int (__stdcall *GetWindowRect)(HWND__ *, tagRECT *);
static auto _dword_BF0444 = reinterpret_cast<_dword_BF0444_t>(0x00BF0444);//!!use microsoft version

using _dword_BF02F4_t = void(__stdcall*)(unsigned int);//void(__stdcall* Sleep)(unsigned int);	//C6D7CC
static auto _dword_BF02F4 = reinterpret_cast<_dword_BF02F4_t>(0x00BF02F4);//!!use microsoft version

using _dword_BF04EC_t = unsigned int(__stdcall*)(unsigned int, void**, int, unsigned int, unsigned int);//unsigned int (__stdcall *MsgWaitForMultipleObjects)(unsigned int, void **, int, unsigned int, unsigned int);
static auto _dword_BF04EC = reinterpret_cast<_dword_BF04EC_t*>(0x00BF04EC);//!!use microsoft version

using _dword_BF04E8_t = int(__stdcall*)(tagMSG*, HWND__*, unsigned int, unsigned int, unsigned int);//int (__stdcall *PeekMessageA)(tagMSG *, HWND__ *, unsigned int, unsigned int, unsigned int);
static auto _dword_BF04E8 = reinterpret_cast<_dword_BF04E8_t>(0x00BF04E8);//!!use microsoft version

using _dword_BF0430_t = int(__stdcall*)(tagMSG*);//int (__stdcall *TranslateMessage)(tagMSG *);
static auto _dword_BF0430 = reinterpret_cast<_dword_BF0430_t>(0x00BF0430);//!!use microsoft version

using _dword_BF042C_t = int(__stdcall*)(tagMSG*);//int (__stdcall *DispatchMessageA)(tagMSG *);
static auto _dword_BF042C = reinterpret_cast<_dword_BF042C_t>(0x00BF042C);//!!use microsoft version

using _dword_BF041C_t = void(__stdcall*)(int);//void (__stdcall *PostQuitMessage)(int);
static auto _dword_BF041C = reinterpret_cast<_dword_BF041C_t>(0x00BF041C);//!!use microsoft version

using _dword_BF064C_t = int(__stdcall*)(unsigned int, const void*, int);//  int (__stdcall *connect)(unsigned int, const void *, int);
...
auto _dword_BF0674 = reinterpret_cast<int(__stdcall*)(unsigned int, const char*, int, int)>(0x00BF0674);
...
using _dword_BF062C_t = int(__stdcall*)(unsigned int, HWND__*, unsigned int, int);//  int (__stdcall *WSAAsyncSelect)(unsigned int, HWND__ *, unsigned int, int);
...
using _sub_494ED1_t = int(__fastcall*)(CClientSocket* pThis, void* edx, int bSuccess);    //sub_494ED1    //end 004954C4
...
using _sub_494D2F_t = void(__fastcall*)(CClientSocket* pThis, void* edx, sockaddr_in* pAddr);    //sub_494D2F	end	00494ECE
...
using _sub_494CA3_t = void(__fastcall*)(CClientSocket* pThis, void* edx, CClientSocket_CONNECTCONTEXT* ctx);   //sub_494CA3	end	00494D04
...
using _sub_494931_t = int(__fastcall*)(void* pThis, void* edx);	//1	//sub_494931	end	00494BE8
...
using _sub_9F7CE1_t = void(__fastcall*)(CWvsApp* pThis, void* edx);	//sub_9F7CE1 end 009F821E
static auto _sub_9F7CE1 = reinterpret_cast<_sub_9F7CE1_t>(0x009F7CE1); //void __thiscall CWvsApp::InitializeInput(CWvsApp *this)

using _sub_9F821F_t = void(__thiscall*)(void* pThis);	 //void __thiscall CInputSystem::CInputSystem(CInputSystem *this)
static auto _sub_9F821F = reinterpret_cast<_sub_9F821F_t>(0x009F821F); //CInputSystem* pThis

using _sub_599EBF_t = void(__thiscall*)(void* pThis, HWND__* hWnd, void** ahEvent);//void __thiscall CInputSystem::Init(CInputSystem *this, HWND__ *hWnd, void **ahEvent)
static auto _sub_599EBF = reinterpret_cast<_sub_599EBF_t>(0x00599EBF); //CInputSystem* pThis //void** ahEvent

using _sub_9F9A6A_t = void*(__cdecl*)();//CInputSystem *__cdecl TSingleton<CInputSystem>::GetInstance()
static auto _sub_9F9A6A = reinterpret_cast<_sub_9F9A6A_t>(0x009F9A6A); //CInputSystem* pThis

using _sub_9F84D0_t = void(__fastcall*)(CWvsApp* pThis, void* edx, int tCurTime);	//sub_9F84D0 end 009F8B5E
...
using _sub_496B68_t = void(__thiscall*)(ZRef<CStage>* pThis, ZRef<CStage>* r); //ZRef<CStage> *this
...
using _sub_496B85_t = void(__thiscall*)(ZRef<CStage>* pThis); //void __thiscall ZRef<CStage>::~ZRef<CStage>(ZRef<CStage> *this)
static auto _sub_496B85 = reinterpret_cast<_sub_496B85_t>(0x00496B85);

using _sub_5F4C16_t = void(__thiscall*)(void* pThis);//void __thiscall CLogin::Update(CLogin *this)
static auto _sub_5F4C16 = reinterpret_cast<_sub_5F4C16_t>(0x005F4C16);

using _sub_9E47C3_t = void(__cdecl*)();
static auto _sub_9E47C3 = reinterpret_cast<_sub_9E47C3_t>(0x009E47C3);//void __cdecl CWndMan::s_Update(void)

using _sub_A5FDE4_t = void(__stdcall*)(HRESULT hr);//void __stdcall _com_issue_error(HRESULT hr)
static auto _sub_A5FDE4 = reinterpret_cast<_sub_A5FDE4_t>(0x00A5FDE4);//!!use microsoft version

using _sub_A5FDF2_t = void(__stdcall*)(HRESULT hr, IUnknown* punk, _GUID* riid);//void __stdcall _com_issue_errorex(HRESULT hr, IUnknown* punk, _GUID* riid)
static auto _sub_A5FDF2 = reinterpret_cast<_sub_A5FDF2_t>(0x00A5FDF2);//!!use microsoft version

using _sub_411BBB_t = void(__thiscall*)(void* pThis);//void __thiscall CActionMan::SweepCache(CActionMan* this)
static auto _sub_411BBB = reinterpret_cast<_sub_411BBB_t>(0x00411BBB);

using _sub_9F5239_t = void(__fastcall*)(CWvsApp* pThis, void* edx);	//sub_9F5239 end 009F5C4F 
static auto _sub_9F5239 = reinterpret_cast<_sub_9F5239_t>(0x009F5239);//void __thiscall CWvsApp::SetUp(CWvsApp *this)

using _sub_9F7097_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::InitializeAuth(CWvsApp *this)
static auto _sub_9F7097 = reinterpret_cast<_sub_9F7097_t>(0x009F7097);

using _sub_A61C60_t = void(__cdecl*)(DWORD);//void __cdecl srand(unsigned int)
static auto _sub_A61C60 = reinterpret_cast<_sub_A61C60_t>(0x00A61C60);

using _sub_44E824_t = void(__cdecl*)();//void __cdecl GetSEPrivilege(void)
...
using _sub_9F9F42_t = void*(__cdecl*)();//CSecurityClient *__cdecl TSingleton<CSecurityClient>::CreateInstance()
static auto _sub_9F9F42 = reinterpret_cast<_sub_9F9F42_t>(0x009F9F42);

using _sub_9F6D77_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::InitializePCOM(CWvsApp *this)
static auto _sub_9F6D77 = reinterpret_cast<_sub_9F6D77_t>(0x009F6D77);

using _sub_9F6D97_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::CreateMainWindow(CWvsApp *this)
static auto _sub_9F6D97 = reinterpret_cast<_sub_9F6D97_t>(0x009F6D97);

using _sub_9F9E53_t = CClientSocket*(__cdecl*)();//CClientSocket *__cdecl TSingleton<CClientSocket>::CreateInstance()
static auto _sub_9F9E53 = reinterpret_cast<_sub_9F9E53_t>(0x009F9E53);

using _sub_9F6F27_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::ConnectLogin(CWvsApp *this)
static auto _sub_9F6F27 = reinterpret_cast<_sub_9F6F27_t>(0x009F6F27);

using _sub_9F9E98_t = void*(__cdecl*)();//CFuncKeyMappedMan *__cdecl TSingleton<CFuncKeyMappedMan>::CreateInstance()
static auto _sub_9F9E98 = reinterpret_cast<_sub_9F9E98_t>(0x009F9E98);

using _sub_9FA0CB_t = void*(__cdecl*)();//CQuickslotKeyMappedMan *__cdecl TSingleton<CQuickslotKeyMappedMan>::CreateInstance()
static auto _sub_9FA0CB = reinterpret_cast<_sub_9FA0CB_t>(0x009FA0CB);

using _sub_9F9EEE_t = void*(__cdecl*)();//CMacroSysMan *__cdecl TSingleton<CMacroSysMan>::CreateInstance()
static auto _sub_9F9EEE = reinterpret_cast<_sub_9F9EEE_t>(0x009F9EEE);

using _sub_9F7159_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::InitializeResMan(CWvsApp *this)
static auto _sub_9sssF7159 = reinterpret_cast<_sub_9F7159_t>(0x009F7159);

using _sub_9F7A3B_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::InitializeGr2D(CWvsApp *this)
static auto _sub_9F7A3B = reinterpret_cast<_sub_9F7A3B_t>(0x009F7A3B);

using _sub_9F82BC_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::InitializeSound(CWvsApp *this)
static auto _sub_9F82BC = reinterpret_cast<_sub_9F82BC_t>(0x009F82BC);

using _sub_9F8B61_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::InitializeGameData(CWvsApp *this)
static auto _sub_9F8B61 = reinterpret_cast<_sub_9F8B61_t>(0x009F8B61);

using _sub_9F7034_t = void(__thiscall*)(CWvsApp* pThis);//void __thiscall CWvsApp::CreateWndManager(CWvsApp *this)
static auto _sub_9F7034 = reinterpret_cast<_sub_9F7034_t>(0x009F7034);

using _sub_538C98_t = void*(__cdecl*)();//CConfig *__cdecl TSingleton<CConfig>::GetInstance()
static auto _sub_538C98 = reinterpret_cast<_sub_538C98_t>(0x00538C98);

using _sub_49EA33_t = void(__thiscall*)(void* pThis, void* pSysOpt, int bApplyVideo);//void __thiscall CConfig::ApplySysOpt(CConfig *this, CONFIG_SYSOPT *pSysOpt, int bApplyVideo)
static auto _sub_49EA33 = reinterpret_cast<_sub_49EA33_t>(0x0049EA33);

using _sub_9F9DA6_t = void*(__cdecl*)();//CActionMan *__cdecl TSingleton<CActionMan>::CreateInstance()
static auto _sub_9F9DA6 = reinterpret_cast<_sub_9F9DA6_t>(0x009F9DA6);

using _sub_406ABD_t = void(__thiscall*)(void* pThis);//void __thiscall CActionMan::Init(CActionMan *this)
static auto _sub_406ABD = reinterpret_cast<_sub_406ABD_t>(0x00406ABD);

using _sub_9F9DFC_t = void*(__cdecl*)();//CAnimationDisplayer *__cdecl TSingleton<CAnimationDisplayer>::CreateInstance()
static auto _sub_9F9DFC = reinterpret_cast<_sub_9F9DFC_t>(0x009F9DFC);

using _sub_9F9F87_t = void*(__cdecl*)();//CMapleTVMan *__cdecl TSingleton<CMapleTVMan>::CreateInstance()
static auto _sub_9F9F87 = reinterpret_cast<_sub_9F9F87_t>(0x009F9F87);

using _sub_636F4E_t = void(__thiscall*)(void* pThis);//void __thiscall CMapleTVMan::Init(CMapleTVMan *this)
static auto _sub_636F4E = reinterpret_cast<_sub_636F4E_t>(0x00636F4E);

using _sub_9F9AC2_t = void*(__cdecl*)();//CQuestMan *__cdecl TSingleton<CQuestMan>::CreateInstance()
static auto _sub_9F9AC2 = reinterpret_cast<_sub_9F9AC2_t>(0x009F9AC2);

using _sub_71D8DF_t = int(__thiscall*)(void* pThis);//int __thiscall CQuestMan::LoadDemand(CQuestMan *this)
static auto _sub_71D8DF = reinterpret_cast<_sub_71D8DF_t>(0x0071D8DF);

using _sub_723341_t = void(__thiscall*)(void* pThis);//void __thiscall CQuestMan::LoadPartyQuestInfo(CQuestMan *this)
static auto _sub_723341 = reinterpret_cast<_sub_723341_t>(0x00723341);

using _sub_7247A1_t = void(__thiscall*)(void* pThis);//void __thiscall CQuestMan::LoadExclusive(CQuestMan *this)
static auto _sub_7247A1 = reinterpret_cast<_sub_7247A1_t>(0x007247A1);

using _sub_9F9B73_t = void*(__cdecl*)();//CMonsterBookMan *__cdecl TSingleton<CMonsterBookMan>::CreateInstance()
static auto _sub_9F9B73 = reinterpret_cast<_sub_9F9B73_t>(0x009F9B73);

using _sub_68487C_t = int(__thiscall*)(void* pThis);//int __thiscall CMonsterBookMan::LoadBook(CMonsterBookMan *this)
static auto _sub_68487C = reinterpret_cast<_sub_68487C_t>(0x0068487C);

using _sub_9FA078_t = void*(__cdecl*)();//CRadioManager *__cdecl TSingleton<CRadioManager>::CreateInstance()
static auto _sub_9FA078 = reinterpret_cast<_sub_9FA078_t>(0x009FA078);

using _sub_414617_t = void(__thiscall*)(ZXString<char>* pThis, const char* s, int n);//void __thiscall ZXString<char>::Assign(ZXString<char> *this, const char *s, int n)
static auto _sub_414617 = reinterpret_cast<_sub_414617_t>(0x00414617);

using _sub_49CCF3_t = void(__thiscall*)(void* pThis, ZXString<char> sModulePath);//void __thiscall CConfig::CheckExecPathReg(CConfig *this, ZXString<char> sModulePath)
static auto _sub_49CCF3 = reinterpret_cast<_sub_49CCF3_t>(0x0049CCF3);

using _sub_62ECE2_t = void(__thiscall*)(void* pThis);//void __thiscall CLogo::CLogo(CLogo *this)
static auto _sub_62ECE2 = reinterpret_cast<_sub_62ECE2_t>(0x0062ECE2);

using _sub_777347_t = void(__cdecl*)(CStage* pStage, void* pParam);//void __cdecl set_stage(CStage *pStage, void *pParam)
static auto _sub_777347 = reinterpret_cast<_sub_777347_t>(0x00777347);

using _sub_9F5C50_t = void(__fastcall*)(CWvsApp* pThis, void* edx, int* pbTerminate);	//sub_9F5C50  end 009F698D  
...
using _sub_49651D_t = void(__thiscall*)(void* pThis);//void __thiscall CClientSocket::ManipulatePacket(CClientSocket *this)
static auto _sub_49651D = reinterpret_cast<_sub_49651D_t>(0x0049651D);

using _sub_59A2E9_t = void(__thiscall*)(void* pThis, DWORD nDeviceIndex);//void __thiscall CInputSystem::UpdateDevice(CInputSystem *this, int nDeviceIndex)
static auto _sub_59A2E9 = reinterpret_cast<_sub_59A2E9_t>(0x0059A2E9);

using _sub_59A306_t = int(__thiscall*)(void* pThis, void* pISMsg);//int __thiscall CInputSystem::GetISMessage(CInputSystem *this, ISMSG *pISMsg)
static auto _sub_59A306 = reinterpret_cast<_sub_59A306_t>(0x0059A306);

using _sub_9F97B7_t = void(__thiscall*)(CWvsApp* pThis, unsigned int message, unsigned int wParam, int lParam);//void __thiscall CWvsApp::ISMsgProc(CWvsApp *this, unsigned int message, unsigned int wParam, int lParam)
static auto _sub_9F97B7 = reinterpret_cast<_sub_9F97B7_t>(0x009F97B7);

using _sub_A605C3_t = void(__stdcall*)(HRESULT hr, void* perrinfo);//void __stdcall _com_raise_error(HRESULT hr, IErrorInfo *perrinfo)
static auto _sub_A605C3 = reinterpret_cast<_sub_A605C3_t>(0x00A605C3);//!!use microsoft version

using _sub_59B2D2_t = int(__thiscall*)(void* pThis, void* pISMsg);//int __thiscall CInputSystem::GenerateAutoKeyDown(CInputSystem *this, ISMSG *pISMsg)
static auto _sub_59B2D2 = reinterpret_cast<_sub_59B2D2_t>(0x0059B2D2);

using _sub_9F6990_t = int(__thiscall*)(IWzGr2D* pThis);//int __thiscall IWzGr2D::GetnextRenderTime(IWzGr2D *this)
static auto _sub_9F6990 = reinterpret_cast<_sub_9F6990_t>(0x009F6990);

using _sub_9E4547_t = void(__cdecl*)();//void __cdecl CWndMan::RedrawInvalidatedWindows(void)
static auto _sub_9E4547 = reinterpret_cast<_sub_9E4547_t>(0x009E4547);

using _sub_777326_t = HRESULT(__thiscall*)(IWzGr2D* pThis);//HRESULT __thiscall IWzGr2D::RenderFrame(IWzGr2D *this)
static auto _sub_777326 = reinterpret_cast<_sub_777326_t>(0x00777326);

using _sub_9F4FDA_t = void(__fastcall*)(CWvsApp* pThis, void* edx, const char* sCmdLine);	//sub_9F4FDA end 009F51D3
...
using _sub_4744C9_t = ZXString<char>*(__thiscall*)(ZXString<char>* pThis, const char* sWhiteSpaceSet);//ZXString<char> *__thiscall ZXString<char>::TrimLeft(ZXString<char> *this, const char *sWhiteSpaceSet)
static auto _sub_4744C9 = reinterpret_cast<_sub_4744C9_t>(0x004744C9);

using _sub_474414_t = ZXString<char>*(__thiscall*)(ZXString<char>* pThis, const char* sWhiteSpaceSet);//ZXString<char> *__thiscall ZXString<char>::TrimRight(ZXString<char> *this, const char *sWhiteSpaceSet)
static auto _sub_474414 = reinterpret_cast<_sub_474414_t>(0x00474414);

using FindFirstFileA_t = HANDLE(WINAPI*)(LPCSTR lpFileName, LPWIN32_FIND_DATAA lpFindFileData);
...
extern GetLastError_t GetLastError_Original;

using _sub_9F51F6_t = void(__fastcall*)(CWvsApp* pThis, void* edx);
static auto _sub_9F51F6 = reinterpret_cast<_sub_9F51F6_t>(0x009F51F6);//void __thiscall CWvsApp::~CWvsApp(CWvsApp *this)

using _sub_9F4E54_t = unsigned int(__fastcall*)(unsigned int* pmem, void* edx, unsigned int size, unsigned int* pcheck, unsigned int* pCrc32);
